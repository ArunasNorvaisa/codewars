/*
 ...
 fnn: a positive integer, the number of checkout tills.
 ...
 queueTime([5,3,4], 1)
 // should return 12
 // because when fnn=1, the total time is just the sum of the times

 queueTime([10,2,3,3], 2)
 // should return 10
 // because here fnn=2 and the 2nd, 3rd, and 4th people in the
